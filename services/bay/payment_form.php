...
<form id="payment_form" action="http://10.100.101.222/services/bay/payment_confirmation.php" method="post">

    <input type="hidden" name="access_key" value="00ff8506ac7e3da4951e0df6bd54b3c7">
    <input type="hidden" name="profile_id" value="1AED3B94-7FF2-4E28-88B8-F546F135BCA1">
