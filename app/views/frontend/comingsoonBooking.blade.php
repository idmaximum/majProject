          ...
          <ul id="tab{{$dayTime}}"  <?php if($dayTime != 0){?> class="hide"<?php }?>>
            <li>@foreach($movie_lists as $movie)  
				...
				?><div class="rowShowToday">
                	<div class="rowShowTodayImage"><a href="{{URL::to("comingsoon/$movie_comingsoonID/$nameMovieSub")}}"><img src="{{asset("uploads/movie/$movie->movie_Img_Thumb")}}" width="140" height="210" class="hoverImg08"></a></div>
                <div class="rowShowTodayDetail">
                  <h2 class="txtGold24"><a href="{{URL::to("comingsoon/$movie_comingsoonID/$nameMovieSub")}}">{{$movie->movie_Name_EN}}</a></h2>
