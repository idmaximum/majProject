    ...
    <div class="contentPage" id="contentComingsoon"> 
       ...
       <div class="rowMonth ">
        <p class="txtWhite25 titleMonth">{{$mounthComingsoon}}</p>
		 ...
		 ?>
       	  <div class="rowShowTodayImage"><a href="{{URL::to("comingsoon/$movieComingsoon->movieID/$nameMovieSub")}}" title="{{$nameMovie}}" ><img src="{{asset("uploads/movie/$movieComingsoon->movie_Img_Thumb")}}" width="117" height="177" class="hoverImg08"  alt="{{$nameMovie}}"></a></div>
         ...
         <div class="detailMovieComingsoon">
          ...
          <?php if($movieComingsoon->movie_Youtube != ""){ ?>
            <p class="txtBrown20_2 icTrail"><a href="{{URL::to("comingsoon/$movieComingsoon->movieID/$nameMovieSub")}}" title="Trailer {{$nameMovie}}">Trailer</a></p>
            <?php }#end if?>
            <?php 
			...
			?>
            <p><a href="{{URL::to("comingsoonbooking/$movieComingsoon->movieID/$nameMovieSub")}}"><img src="{{asset("images/btn-comingsoon-booknow.png")}}" width="120" height="42" class="hoverImg08"  alt="Booking Now"></a></p>
            <?php }?>
          </div>
          <p class="clear"></p>
        </div>
