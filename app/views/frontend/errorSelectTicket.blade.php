...
<div id="main">
  @include('frontend.incHeader')   
     ...
     <div class="titleMovie"> 
      <a href="{{URL::to("selectTicket/$movieID/$sessID")}}"><img src="{{asset("images/btn-back.png")}}"  alt="btn Back"></a>
    </div><br><br> 
		...
		<div class="content-next clear" style="text-align:center">  
 		 <a href="{{URL::to("selectTicket/$movieID/$sessID")}}"><img src="{{asset("images/btn_seat_prev.png")}}" width="120" height="46"></a> &nbsp; &nbsp; &nbsp; </div> <br>
<br>
<br>
