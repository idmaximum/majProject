   ...
   <?php   /*<div class="page-information">
    ...
    <div class="contentPage" style="background-color:#000000">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tbody>
          <tr>
            <td height="540" style="background-image:url(images/bg_info_top.jpg); background-repeat:no-repeat">&nbsp;</td>
          </tr>
          <tr>
          ...
          <tr>
            <td height="571" style="background-image:url(images/bg_hall_1.jpg); background-repeat:no-repeat; background-position:top center">&nbsp;</td>
          </tr>
          <tr>
          ...
          <tr>
            <td height="460" align="center">
            <ul class="bxslider">
  <li><img src="images/grand_sofa.png" /></li>
  <li><img src="images/large_day.png" /></li>
  <li><img src="images/couch.png" /></li>
  <li><img src="images/day_bed.png" /></li>
  <li><img src="images/loft.png" /></li>
</ul>
            </td>
          </tr>
          <tr>
            <td height="640" style="background-image:url(images/bg_hall_2.jpg); background-repeat:no-repeat">&nbsp;</td>
          </tr>
          <tr>
            <td align="center"><p><img src="images/cocoon.png" alt="CoCoon Seat"/></p>
              <p>&nbsp;</p>
            <p>&nbsp;</p>
            ...
            <p class="txtBrown18_2">&nbsp;</p>
    <?php       /* <p class="txtBrown18_2"><img src="images/divide_info.jpg" width="80" height="1" alt=""/></p>
            <p class="txtBrown18_2">&nbsp;</p>
            <p class="txtBrown18_2">&nbsp;</p>
          ...
          <tr>
            <td valign="bottom" bgcolor="#1f2022"><img src="images/bg_info_footer.jpg" width="1024" height="170" alt=""/></td>
          </tr>
        </tbody>
      </table>
    </div>
