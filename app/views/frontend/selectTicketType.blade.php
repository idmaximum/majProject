...
<div id="main">
  ...
  <div id="content" class="content-main">
    <div class="titleMovie">
      <input type="image" src="{{asset('images/btn-back.png')}}" class="buttonBack hoverImg08"  onclick="history.back(-1)" >
    </div>
    <div class="contentPage">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
			...
			?><p><img src="{{asset("images/icon/$imgRate")}}" alt="{{$movie->movie_Rating}}" style="padding:0; padding-right:5px; max-width:40px"> 
                  ...
                  <td width="89%" class="txtSoundTrack" style="padding-left:5px"><?php
      ...
      <?php }#end foreach?>
        ...
        <div class="content-next clear">
          <input type="image" src="{{asset('images/btn_seat_next.png')}}" class="buttonBack hoverImg08 {{$style45Mins}} " >
        </div>
      </form>
    </div>
  </div> 
