  ...
  @include('frontendTH.incHeader') 
    ...
    <div class="contentPage">
      <div class="contact-content-left">
        ...
        <p><a href="https://www.google.co.th/maps/ms?msa=0&amp;msid=214690672533320494157.0004f8ca093fe2e8d418a&amp;hl=th&amp;ie=UTF8&amp;ll=13.743585,100.547369&amp;spn=0,0&amp;t=m&amp;source=embed" target="_blank"><img src="{{asset('images/view_contact_map.jpg')}}" width="630" height="40" style="margin-top:-2px"></a></p>
     ...
     <div class="form-contact">
      ...
      <div class="contact-content-right">
        ...
        <div class="txtBrown18_2"><br>
          <div class="row-contact">
            <div class="row-contact-left"><img src="{{asset('images/ic-train-bts.png')}}" width="85" height="65"></div>
          ...
          <div class="row-contact">
            <div class="row-contact-left"><img src="{{asset('images/ic-bus.png')}}" width="85" height="53"></div>
            <div class="row-contact-right">
              <p>BUS</p>
