...
<div id="main">
  ...
  <div id="content" class="content-main">
    <div class="titleMovie">
      <input type="image" src="{{asset('images/btn-back.png')}}" class="buttonBack"  onclick="history.back(-1)" >
    </div>
    <div class="contentPage">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
			...
			?><p><img src="{{asset("images/icon/$imgRate")}}" alt="{{$movie->movie_Rating}}" style="padding:0; max-width:40px"> 
                  ...
                  <td width="89%" class="txtSoundTrack"><?php
      ...
      <div class="movie-step">
        <p>&nbsp;</p>
        <p><img src="{{asset('images/step_seat_type.png')}}" width="1024" height="81"></p>
      </div>
      <form action="{{URL::to("th/selectSeats")}}" method="post" class="formTypeSeat">
      ...
      <?php 
		...
		?><li><div class="row-seat">
       	    ...
       	    <p class="txtBrown18_2">{{$PRICE_STRTICKET_TYPE_DESCRIPTION}}</p>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="divBtnSelectSeat">
              <tr>
                ...
                <div  class="btnSub btnCountSeat" id="btnSub{{$PRICE_STRTICKET_TYPE_CODE}}"><img src="{{asset("images/btnsub-seat-type.png")}}" width="46" height="42"></div></td>
                ...
                <td width="46" valign="top">
                <div class="btnPlus btnCountSeat" id="btnPls{{$PRICE_STRTICKET_TYPE_CODE}}"><img src="{{asset("images/btnplus-seat-type.png")}}" width="45" height="42"></div></td>
              </tr>
            </table>
       	  </div></li>
      ...
      <?php }#end foreach?>
        ...
        <div class="content-next clear">
          <input type="image" src="{{asset('images/btn_seat_next.png')}}" class="buttonBack" >
        </div>
      </form>
    </div>
  </div> 
...
<div style='display:none'>
    ...
    <p  class="txtBlack20"><strong>Please select seat type</strong></p> 
    </div>
    <div id='inline_limit' style='padding:30px; background:#fff;text-align:center'>
    <p  class="txtBlack20"><strong>Maximum 6 seats per transaction.</strong></p> 
    </div>
</div>
