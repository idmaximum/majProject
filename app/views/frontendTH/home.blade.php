...
<body><?php 
  ...
  <div id="content" class="content-main" style="padding-top:18px"> 
    ...
    <div class="rowShowToday  ">
      <div class="rowShowTodayImage"><a href="{{URL::to("th/"."movie/$movie->movieID/$nameMovieSub")}}" title="{{$nameMovie}}"><img src="{{asset("uploads/movie/$movie->movie_Img_Thumb")}}" width="140" height="210" class="hoverImg08"></a></div>
      <div class="rowShowTodayDetail">
        <h2 class="titleMovieName txtGold24 fontTHLang"><a title="{{$nameMovie}}" href="{{URL::to("th/"."movie/$movie->movieID/$nameMovieSub")}}">{{$nameMovie}}</a></h2>
