...
<link media="all" type="text/css" rel="stylesheet" href="{{$config_path}}/css/screenTH.css"> 
...
<div id="main"> @include('frontendTH.incHeader')
  ...
  <div id="content" class="content-main">
    <div class="titleMovie"> <a href="{{URL::to("selectTicket/$movieID/$sessID")}}"><img src="{{asset("images/btn-back.png")}}"  alt="btn Back" class="hoverImg08"></a> </div>
    <div class="contentPage"> @foreach($movie_DataDetail as $movie)
	 ...
	 ?>
      <div class="content-detail-movie">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="82%" align="left" valign="top"><h2 class="txtGold26 fontTHLang">{{$movieName}}</h2>
              <p>&nbsp;</p>
              <p>&nbsp;</p>
              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
      ...
      <div class="movie-step">
        <p>&nbsp;</p>
        <p><img src="{{asset("images/step_seat_type_2.png")}}" width="1024" height="81"></p>
      </div>
      <div class="content-seat-type">
        ...
        <p>&nbsp;</p
          >
        <p><img src="{{asset("images/12_theatre_3_07.png")}}" width="1021" height="153"></p>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="47%" valign="top"><p>&nbsp;</p>
              <p>&nbsp;</p>
              <p style="text-align:center"><img src="{{asset("images/txt_confirm_booking.png")}}" width="367" height="22"></p>
              <?php
		 	 $cname = '';
			 $email = '';
			 $mobile = '';
              ...
              <form action="{{URL::to("submitReserve")}}" method="post" class="formPayment">
                ...
                <table width="100%">
                  <tr>
					...
					?>
                      <input type="image" src="{{asset("images/btn_reserve.png")}}" class="buttonBack hoverImg08" id="bookingConfirm">
                      <?php 	}else{?>
                    ...
                    <td align="left" width="50%">&nbsp;
                      <input type="image" src="{{asset("images/btn_buy.png")}}" class="buttonBack hoverImg08" id="payment"  onclick="javascript: form.action='http://www.embassycineplex.com/services/bay/payment_confirmation.php';"></td>
                  </tr>
                </table>
      ...
      <br>
      <br>
      <div class="content-next clear" id="prevBTN"> <a href="{{URL::to("selectTicket/$movieID/$sessID")}}"><img src="{{asset("images/btn_seat_prev.png")}}" width="120" height="46" class="hoverImg08"></a> &nbsp; &nbsp; &nbsp; </div>
    </div>
  </div>
    <div class="url">
