...
<div id="main"> @include('frontendTH.incHeader')
  <div id="content" class="content-main">
    <div class="contentPage">
      <div class="titleMovie">
        <div class="content-movie-left" style="padding-top:10px"><a href="{{URL::to('th/comingsoon')}}"><img src="{{asset('images/6_movie_detail_09.png')}}" width="88" height="20" class="hoverImg08"></a></div>
        <div class="content-movie-right">
          <h1 class="fontTHLang titleMovieName txtGold36">{{$movieName}}</h1>
      ...
      <div class="detailMovie">
        <div class="content-movie-left">
          ...
          <p style="padding:3px;"></p>
      	  <p class="txtWhite20 fontTHLang">{{$movie->movie_Duration}} Min</p>
      	  <p>&nbsp;</p><p>&nbsp;</p>
          @endif
  ...
  <div style='display:none'>
    ...
    <p><img src="{{asset('images/logo.png')}}" width="171" height="124" alt="Embassy" class="hoverImgLogo"></p><br>
<br> 
