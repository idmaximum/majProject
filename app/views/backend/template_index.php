    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="100%" border="0" cellspacing="4" cellpadding="0">
            <tr>
              <td width="71%" align="left"><a class="btn btn-success" href="primary_colors_add.php#color">เพิ่ม | Add New</a></td>
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0"  class="table table-striped">
            ...
            <tbody> 
            @foreach($newsDB as $row)
            <tr>
              <td>{{$row->news_title}}</td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td align="center"><a href="newsEdit/{{$row->news_id}}"><img src="{{asset('images/png/glyphicons_030_pencil.png')}}" width="20" height="20" /></a></td>
              <td align="center">
              <label class="checkbox-inline">
                  <input type="checkbox"   name="sel_newsid[]" value="{{$row->news_id}}">
                </label></td>
            </tr>
            @endforeach
              </tbody>
