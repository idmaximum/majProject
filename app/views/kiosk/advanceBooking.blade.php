<?php
	...
	$config_path = "https://www.embassycineplex.com";
	 // $config_path = "http://localhost/embassy_V2";
?><!doctype html>
<html>
<head>
<meta charset="utf-8">
          ...
          <ul id="tab{{$dayTime}}"  <?php if($dayTime != 0){?> class="hide"<?php }?>>
            <li>@foreach($movie_lists as $movie)  
				...
				?><div class="rowShowToday">
                	<div class="rowShowTodayImage"><a href="{{URL::to("kiosk/movie/$movie->movieID/$nameMovieSub")}}"><img src="{{asset("uploads/movie/$movie->movie_Img_Thumb")}}" width="140" height="210" class="hoverImg08"></a></div>
                <div class="rowShowTodayDetail">
                  <h2 class="txtGold24"><a href="{{URL::to("kiosk/movie/$movie->movieID/$nameMovieSub")}}">{{$movie->movie_Name_EN}}</a></h2>
