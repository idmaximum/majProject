...
<link href="{{$config_path}}/js/Keyboard/css/ui-dark.css" rel="stylesheet">
<link media="all" type="text/css" rel="stylesheet" href="{{$config_path}}/js/Keyboard/css/keyboard.css"> 
...
<div id="main"> @include('kiosk.incHeader')
  ...
  <div id="content" class="content-main">
    <div class="titleMovie"> <a href="{{URL::to("kiosk/selectTicket/$movieID/$sessID")}}"><img src="{{asset('images/btn-back.png')}}"  alt="btn Back" class="hoverImg08"></a> </div>
    <div class="contentPage"> @foreach($movie_DataDetail as $movie)
	 ...
	 ?>
      ...
      <div class="movie-step">
        <p>&nbsp;</p>
        <p><img src="../images/step_seat_type_2.png" width="820" ></p>
      </div>
      <div class="content-seat-type">
        ...
        <p>&nbsp;</p
          >
        <p><img src="../images/12_theatre_3_07.png" width="820" height="153"></p>
        <div style="width:820px; margin:auto; text-align:center;color: #f1e3c2;text-transform: uppercase;">
          <?php 	   
			  ...
			  for ($idxRow = $rowCount-1; $idxRow >= 0; $idxRow--) 
			  {
				...
				$allSeats[$idxRow][$idxCol]['SeatStyle'];*/ 
						...
						//  echo "<img src='" . $imgName . ".png'><br />";
						  echo "<p class='".$styleBlank."' ><img src='" . $imgName . ".png'><p>";  
      ...
      <div class="content-seat-type">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  ?>
              <form action="{{URL::to("kiosk/submitReserve")}}" method="post" class="formPayment">
                <div style="width:336px; margin:auto; ">
                <!--  <p><label for="cname" class="txtBrown18_2">Your Name</label><p>  -->    
                	<div class="txtWhite18" style="text-align:left">Your Name</div>            
                    <div style="position:relative"><input type="text" name="cname" value="{{$cname}}" id="cname" class="validate[required]  txtBrown18_2 cName" autocomplete="off"></div><br> 
                <!--  </p><label for="email" class="txtBrown18_2">Your E-mail</label></p>-->
                 
                    <div class="txtWhite18" style="text-align:left">Your E-mail</div>  
                     <div style="position:relative"><input type="email" name="email" value="{{$email}}" id="email" class="validate[required] cEmails txtBrown18_2" autocomplete="off"></div><br> 
              <!--    <p><label for="mobile" class="txtBrown18_2">Mobile No.</label></p>-->
          
                   <div class="txtWhite18" style="text-align:left">Mobile No.</div>  
                    <div style="position:relative"> <input type="number" name="mobile" value="{{$mobile}}" id="mobile" class="validate[required]  txtBrown18_2 cMobile" autocomplete="off"> </div><br> 
                </div>
                <input name="url" type="text" class="url">
                <table width="100%">
                  <tr>
                    <td align="center" ><?php $dateBooking = date('Y-m-d H:i', strtotime(" +60 minutes")); 
						if($dateBooking < $movie->showtime_dtmDate_Time){ 
					?><input type="image" src="{{asset("images/btn-confirm-booking.png")}}" class="buttonBack hoverImg08" id="bookingConfirm"><?php 	}else{?>
      ...
      <br>
      <br>
      <div class="content-next clear" id="prevBTN"> <a href="{{URL::to("kiosk/selectTicket/$movieID/$sessID")}}"><img src="../images/btn_seat_prev.png" width="120" height="46" class="hoverImg08"></a> &nbsp; &nbsp; &nbsp; </div>
    </div>
  </div>
    <div class="url">
...
{{ HTML::script('js/Keyboard/js/jquery.keyboard.js') }} 
            ...
            displayHours: false
			  ...
			  jQuery.ajax({
				url : '{{URL::to("cancelTicket")}}', 
					...
					window.location = '{{URL::to("kiosk/selectTicket/$movieID/$sessID")}}'; 
				 }
			});   
		  });
		  //****************
