  ...
  <div id="content" class="content-main">
    <div class="contentPage">
      <div class="titleMovie">
        <div class="content-movie-left" style="padding-top:10px"><a href="{{URL::to('kiosk/advancebooking')}}"><img src="{{asset('images/6_movie_detail_09.png')}}" width="88" height="20" class="hoverImg08"></a></div>
			...
			?><img src="{{asset("images/icon/$imgSystem")}}" alt="{{$systemName}}"></td>
                  <td width="78%" align="right" style="padding-top:10px"><?php	$numKL = 1;
				   ...
				   ?><div class="rowShowTime  hoverImg08 {{$style45Mins}} {{$classTime}}"> @if($movieShowtime->showtime_strName == 'Theatre 1')
					  ...
					  ?><a href="{{URL::to("kiosk/$urlPage")}}" title="Audio: {{subLanguage($audio)}}   / Subtitle: {{subLanguage($subtitle)}} " class="tooltip">{{ date('H:i', strtotime($movieShowtime->showtime_dtmDate_Time))}}</a> <?php
